...
Original file is located at
    https://colab.research.google.com/drive/16_--nAwGxamczdYlsHkagI3c_P_LQ-wk
"""
...
def get_lyrics(video_id):
    ...
    """
    try:
        # Get the transcript, prioritizing the English one if available.
        # This library is smart enough to handle different languages and generated captions.
...
To run this application, you first need to set up your environment by installing the necessary Python packages. Open your terminal or command prompt and run the following command:

```bash
pip install streamlit youtube-transcript-api
```

Once the installation is complete, save the code above in a file named `app.py`. Then, from the same directory in your terminal, run the Streamlit application with this command:
